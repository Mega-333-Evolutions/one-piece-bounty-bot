...
from src.tg_compat.error import RetryAfter, Forbidden
...
from src.tg_compat import User as TelegramUser
from src.tg_compat.error import BadRequest, TimedOut, NetworkError
