...
# Telethon requires a Telegram API id/hash pair (from https://my.telegram.org)
# in addition to the bot token - python-telegram-bot didn't need these since
# it talks to the Bot API over HTTP instead of MTProto directly.
