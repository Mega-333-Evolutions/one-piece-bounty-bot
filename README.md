...
- Obtain a Telegram API id/hash pair from [my.telegram.org](https://my.telegram.org) (under "API
  Development tools") - this is required by Telethon in addition to the bot token
